...
<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="<?php echo URLROOT ;?>/Dashboards/index">
    ...
    <div class="collapse navbar-collapse w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link <?php if(($_SERVER['REQUEST_URI'] == '/gestion-d-cole/Dashboards/index')||($_SERVER['REQUEST_URI'] == '/gestion-d-cole/')) echo'active'; ?>" href="<?php echo URLROOT ;?>/Dashboards/index">
