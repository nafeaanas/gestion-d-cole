      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          ...
          <ul class="navbar-nav collapse" id="collapseExample" style="width: 80%; margin-left: 10%;">
            <li class="nav-item">
              <a class="nav-link " href="professeurs.html">
                <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
              <a class="nav-link " href="étudiants.html">
                <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                  <i class="ni ni-calendar-grid-58 text-secondary text-sm opacity-10"></i>
                </div>
            ...
            <li class="nav-item">
              <a class="nav-link active" href="parents.html">
                <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                  <i class="ni ni-calendar-grid-58 text-secondary text-sm opacity-10"></i>
                </div>
            ...
            <li class="nav-item">
              <a class="nav-link " href="administrateurs.html">
                <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                  <i class="ni ni-calendar-grid-58 text-secondary text-sm opacity-10"></i>
                </div>
